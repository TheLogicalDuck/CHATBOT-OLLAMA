...
if SO == "Darwin":
    ...
    PERSONAJE = "Einstein"; EMOJI_PERSONAJE = "🧠"; VOZ = "Juan"
else:
    PERSONAJE = "Turing"; EMOJI_PERSONAJE = "💻"; VOZ = None
...
def main(page: ft.Page):
    ...
    def enviar_click_streaming(e):
        ...
        cont = ft.Row(
            [
                ft.Container(live_text, bgcolor=ft.Colors.GREY_300, padding=12, border_radius=30, width=350),
                ft.Text(EMOJI_PERSONAJE, size=24),
            ],
        ...
        try:
            ...
            for line in r.iter_lines():
                ...
                if "response" in data:
                    # ✅ Acumular texto en lugar de reemplazarlo
